...
class RecipeLoader {
    ...
    renderRecipes() {
        ...
        dishTypeFilters.innerHTML = `<h3>${this.recipesData.ui.section_headers.dish_types}</h3>`;
        ...
        dietaryFilters.innerHTML = `<h3>${this.recipesData.ui.section_headers.dietary_options}</h3>`;
