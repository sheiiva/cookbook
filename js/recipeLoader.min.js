    ...
    setupFilterListeners() {
        ...
        document.querySelectorAll('.dietary-toggle').forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                this.applyDietaryFilters();  // Apply all active filters
            });
        });
    }
        ...
        recipeLinks.forEach(link => {
            ...
            if (recipe && recipe.tags) {
                ...
                if (activeFilters.length > 0) {
                    // Recipe must match ALL active filters to be shown
                    shouldShow = activeFilters.every(filter => recipe.tags.includes(filter));
                    console.log(`Recipe ${recipeId}: matches all active filters = ${shouldShow}`);
                }
                ...
                if (shouldShow) {
                    ...
                    console.log(`Hiding ${recipeId} (doesn't match all active filters)`);
